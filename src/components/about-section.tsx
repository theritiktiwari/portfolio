		...
		>
			...
			<div className="text-muted-foreground space-y-4">
				...
				<p>
					...
					, a platform designed to monitor and audit website performance. In this role, I
					architect multi-tenant structures and modular APIs that serve thousands of
					users. I spend my time architecting APIs and building out the{" "}
				...
				<p>
					Previously, I&apos;ve worked on a variety of digital products, handling
					everything from payment integrations and subscription logic to managing
					production environments. I focus on writing defensive, maintainable code that
					solves real technical problems without adding unnecessary complexity.
				</p>
				<p>
					Outside of work, you can usually find me at the{" "}
					<span className="inline-block">
						<span className="group relative inline-flex">
							<span className="text-foreground cursor-help font-semibold">gym</span>
							<span className="pointer-events-none absolute bottom-full left-1/2 mb-2 -translate-x-1/2 opacity-0 transition-all group-hover:mb-3 group-hover:opacity-100">
					...
					focusing on my fitness goals, or working on{" "}
					<span className="text-foreground font-semibold">FinLink</span>, a personal
					project I&apos;m building to help track net-worth automatically.
				</p>
			</div>
		</section>
	);
