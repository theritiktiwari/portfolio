...
const Certificates = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (newTitle && newDescription && newImage && newDate && newLink) {
                let Add = await addDoc(collection(db, "certificates"), {
                    title: newTitle,
                ...
                if (Add.id) {
                    tst("Certificate added successfully", "success");
    ...
    const delData = async (id) => {
        try {
            alert("Are you sure you want to delete this certificate ?");
            await deleteDoc(doc(db, "certificates", id));
            tst("Certificate deleted successfully", "success");
            router.push("/admin/certificates");
        } catch (error) {
            tst("Something went wrong", "error");
        }
    ...
    const updateData = async (id) => {
        try {
            ...
            tst("certificate updated successfully", "success");
    ...
    return (
        <>
            ...
            <section className='container mx-auto py-5'>
                <h2 className="text-center mb-4">Manage Certificates</h2>
                                            ...
                                            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                <div className="modal-content">
                                                    <div className="modal-header">
                                                        <h5 className="modal-title" id="exampleModalLabel">Update Certificate</h5>
