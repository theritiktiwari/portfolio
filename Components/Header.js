                ...
                <div className="navbar">
                    ...
                    <div className="center-nav">
                        <ul className="nav-links">
                            <li><Link href="/"><a className="nav-link link">Home</a></Link></li>
                            <li>
                            ...
                            <li>
                                <a className="nav-link">Skills <i className="fas fa-caret-down"></i></a>
                                <ul className="dropdown">
                                    <li><Link href="/skills"><a><i className="fas fa-code"></i>Skill Set</a></Link></li>
                                    <li><Link href="/codingprofile"><a><i className="fas fa-laptop-code"></i>Coding Profiles</a></Link></li>
                                    <li><Link href="/opensource"><a><i className="fas fa-code-branch"></i>Open Source Profiles</a></Link></li>
                                </ul>
                            </li>
                            <li>
                                <a className="nav-link">Work <i className="fas fa-caret-down"></i></a>
                                <ul className="dropdown">
                                    <li><Link href="/projects"><a><i className="fas fa-clipboard"></i>Projects</a></Link></li>
                                    <li><Link href="/experience"><a><i className="fas fa-users"></i>Experience</a></Link></li>
                                    <li><Link href="/services"><a><i className="fas fa-microchip"></i>Services</a></Link></li>
                                </ul>
                            </li>
                            <li>
                                <a className="nav-link">Other<i className="fas fa-caret-down"></i></a>
                                <ul className="dropdown">
                                    <li><Link href="/certificates"><a><i className="fas fa-certificate"></i>Certificates</a></Link></li>
                                    <li><Link href="/achievements"><a><i className="fas fa-trophy"></i>Achievements</a></Link></li>
